...
CREATE TABLE MUDENGINE_BEING.MUD_BEING_CLASS_ATTR (
		...
		FOREIGN KEY (BEING_CLASS) REFERENCES MUDENGINE_BEING.MUD_BEING_CLASS(BEING_CLASS) on delete cascade
);
...
CREATE TABLE MUDENGINE_BEING.MUD_BEING_CLASS_SLOT (
		...
		CONSTRAINT MUD_BEING_CLASS_SLOT_PK PRIMARY KEY (BEING_CLASS, SLOT_CODE),
		FOREIGN KEY (BEING_CLASS) REFERENCES MUDENGINE_BEING.MUD_BEING_CLASS(BEING_CLASS) on delete cascade
);
