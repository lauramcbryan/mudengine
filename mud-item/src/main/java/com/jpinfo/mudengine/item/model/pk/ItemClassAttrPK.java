 ...
 */
@Embeddable
public class ItemClassAttrPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ItemClassAttrPK)) {
			return false;
		}
		ItemClassAttrPK castOther = (ItemClassAttrPK)other;
		return 
