...
public class ClientLocalizedMessages {
	
	public static final Logger log = LoggerFactory.getLogger(ClientLocalizedMessages.class);
	...
	public ClientLocalizedMessages(Locale locale) {
