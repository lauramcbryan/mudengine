...
insert into mud_action_class_cmd_parameter(command_id, name, input_message, type, required, domain_values, default_value) 
	values (1, 'targetCode', 'Please input the direction', 'DIRECTION', 1, null, null);

insert into mud_action_class_cmd(command_id, action_class_code, verb, description, usage, locale) 
	values(101, 1, 'VÁ PARA', 'Ir para outro lugar', 'VÁ PARA <DIREÇÃO>', 'pt-BR');

insert into mud_action_class_cmd_parameter(command_id, name, input_message, type, required, domain_values, default_value) 
	values (101, 'targetCode', 'Por favor indique a direção', 'DIRECTION', 1, null, null);
...
insert into mud_action_class_cmd_parameter(command_id, name, input_message, type, required, domain_values, default_value) 
	values (3, 'targetCode', 'Please input the being to look at', 'BEING', 1, null, null);
...
insert into mud_action_class_cmd_parameter(command_id, name, input_message, type, required, domain_values, default_value) 
	values (103, 'targetCode', 'Por favor, indique o ser a examinar', 'BEING', 1, null, null);
...
insert into mud_action_class_cmd_parameter(command_id, name, input_message, type, required, domain_values, default_value) 
	values (4, 'targetCode', 'Please input the item to look at', 'ITEM', 1, null, null);

insert into mud_action_class_cmd(command_id, action_class_code, verb, description, usage, locale) 
	values(104, 4, 'EXAMINE', 'Obtém detalhes de um item', 'EXAMINE <ITEM>', 'pt-BR');

insert into mud_action_class_cmd_parameter(command_id, name, input_message, type, required, domain_values, default_value) 
	values (104, 'targetCode', 'Por favor, indique o item a examinar', 'ITEM', 1, null, null);
