...
public class BeingClass implements Serializable {
	...
	private List<BeingClassAttr> attributes;

	//bi-directional many-to-one association to MudBeingClassSkill
	@OneToMany(mappedBy="id.beingClass")
	private List<BeingClassSkill> skills;
	...
	public List<BeingClassAttr> getAttributes() {
		return this.attributes;
	}

	public List<BeingClassSkill> getSkills() {
		return this.skills;
	}
}